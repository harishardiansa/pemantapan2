    ...
    <div class="col-md-12">
        <form method="post">
            ...
            if(isset($_POST['submit'])) {
                ...
                $stok = $_POST['stok'];
                $foto = $_POST['foto'];
                $query = mysqli_query($koneksi, "UPDATE buku SET id_kategori='$id_kategori', judul='$judul', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', stok='$stok', deskripsi='$deskripsi', foto='$foto' WHERE id_buku=$id");
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8">
                <div name="deskripsi"><input type="file" class="form-control" name="foto"></div> 
            </div>
            <div class="row">
