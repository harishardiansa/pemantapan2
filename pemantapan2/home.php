<h1 class="mt-4">Dashboard</h1>
       ...
       ?>
                                        <a class="small text-white stretched-link" href="?page=kategori">Lihat Lebih Lanjut</a>
                            ...
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-warning text-white mb-4">
                                    ...
                                    ?>   
                                        Total Buku</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="?page=buku">Lihat Lebih Lanjut</a>
                                        <div class="small text-white"><i class="fas fa-book"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-success text-white mb-4">
                                    ...
                                    Total Ulasan</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="?page=ulasan">Lihat Lebih Lanjut</a>
                            ...
                            <div class="col-xl-3 col-md-3">
                                <div class="card bg-danger text-white mb-4">
                                    ...
                                    Total User</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="?page=user">Lihat Lebih Lanjut</a>
