    ...
    <div class="col-md-12">
        <form method="post">
            ...
            if(isset($_POST['submit'])) {
                ...
                $foto = $_POST['foto'];
                $query = mysqli_query($koneksi, "INSERT INTO buku(id_kategori,judul,penulis,penerbit,tahun_terbit,stok,deskripsi,foto) values ('$id_kategori','$judul','$penulis','$penerbit','$tahun_terbit','$stok','$deskripsi','$foto')");
